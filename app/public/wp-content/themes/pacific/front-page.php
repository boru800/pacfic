...
<?php 
    ...
    $mall_posts = new WP_Query('posts_per_page=-1&post_type=page&orderby=menu_order&order=asc&post_parent=63');
...
<?php the_post_thumbnail('pickup_thumbnail', 
    array( 
...
?>
      <article class="column-article">
        <h1 class="update-title"><a href="<?php the_permalink() ?>"><?php the_title() ?></a></h1>
