<section id="sidebar">
    <aside class="rss_link">
        ...
        the_feed_link(
            ...
            '/images/btn_rss_feed.png" width="250" height="28" art="RSS" />'
        );
        ?>
    </aside>
...
<aside id="<?php echo $sidebar_cat_name?>-info" class="news-list">
            <h1><?php echo get_category_by_slug($sidebar_cat_name)->name; ?></h1>
            <div class="info-wrap">
                <ul>
...
?>
                    <li>
                    <time pubdate="pubdate" datetime="the_time('Y-m-d');" class="entry-date"><?php the_time(get_option('date_format'));?></time>
...
?>
                ...
                <span class="link-text"><a href="<?php get_term_link($sidebar_cat_name, 'category') ?>"><?php echo get_category_by_slug($sidebar_cat_name)->name; ?>一覧</a></span>
            </div><!-- .info-wrap end -->
